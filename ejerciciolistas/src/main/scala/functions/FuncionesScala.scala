...
object FuncionesScala {
  ...
  // Funcion literal Área de un circulo
  // como objeto de la clase Function1
...
// Funcion recursiva
 ...
 def factorialTail(n:Int, acum:Int):Int ={
   if(n == 0) acum else if(n == 1) acum else factorialTail(n-1, acum*n)}
}
